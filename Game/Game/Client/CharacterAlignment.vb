    ...
    Public Class CharacterAlignment
        ...
        Public ReadOnly Property Rank As Integer
            Get
                ...
                For i As Integer = 1 To ExperienceTable.MaxLevel
                    If ExperienceTable.AtLevel(i).Pvp = -1 Then Exit For
                    If Exp >= ExperienceTable.AtLevel(i).Pvp Then
                        mRank = i
                    End If
                Next
                Return mRank
        ...
        Public Property Exp As Long
            ...
            Set(ByVal value As Long)
                ...
                If m_Exp > ExperienceTable.AtLevel(10).Pvp Then m_Exp = ExperienceTable.AtLevel(10).Pvp
            End Set
        End Property
