...
Namespace Game
    Public Class Character
        ...
        '   Public CurrentFM As New World.FM(New Item, World.MagicalForgeManager.GetruneByTemplateID(1557), 100)
        Public CurrentCraft As Crafts
        ...
        Sub SendAccountStats(client As GameClient)
