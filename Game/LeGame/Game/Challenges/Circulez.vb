...
Namespace Game
    Public Class Circulez : Inherits Challenge
        ...
        Public Overrides Sub CheckSpell(ByVal Fighter As World.Fighter, ByVal Effect As SpellEffect, ByVal Cibles As System.Collections.Generic.List(Of World.Fighter), ByVal Cell As Integer)
            ...
            If (Effect.Effect = Game.Effect.SubPM OrElse Effect.Effect = Game.Effect.VolPM) AndAlso Cibles.Where(Function(c) c.Team <> Fighter.Team).Count <> 0 Then
                Fail()
            End If
