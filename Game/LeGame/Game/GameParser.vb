    ...
    Public Class GameParser
        ...
        Private Sub ExchangeRequest(ByVal ExtraData As String)
            ...
            Select Case Data(0)
                ...
                Case 6 ' Sac Marchand
                    ...
                    End If
                Case 10 'HDV VENTE
                    HdvManager.Open(Client, True)
                Case 11 'HDV ACHAT
                    HdvManager.Open(Client, False)
            End Select
        ...
        Private Sub ExchangeMoveItem(ByVal ExtraData As String)
            ...
            If Client.Character.State.IsFM Then
                ...
                'fm
                Select Case JobManager.JobsType(Client, Client.Character.State.CurrentGameAction)
                End Select

            End If
            If Client.Character.State.isTradingHDVBUY Or Client.Character.State.isTradingHDVSOLD Then
                Dim price As Integer = 0
                ...
                Case "E"
                    ...
                    Select Case Packet(1)
                        ...
                        Case "f"
                            ...
                            End Select
                        Case "T"
                            HdvManager.Sendtemplateid(Packet.Substring(3), Client, Client.Character.State.isTradingHDVSOLD)
                        Case "P"
                            HdvManager.senditeminfos(Packet.Substring(3), Client)
                        Case "B"
                            Dim data As String() = Packet.Substring(3).Split("|")
                            HdvManager.Buy(data(0), data(2), Client)
        ...
        Private Sub EndAction(ByVal ActionType As String, ByVal Args As String)
            ...
            Select Case ActionType
                ...
                Case "K"
                    ...
                    ElseIf Client.Character.State.IsFauching Then
                        JobManager.EndActionJobRecolte(Client.Character.MapCell, Client)
