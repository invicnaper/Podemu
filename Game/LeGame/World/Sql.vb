...
Namespace Utils
    Public Class Sql
        ...
        Public Shared Characters As New MySqlConnection
        Public Shared Others As New MySqlConnection

        Public Shared AccountsSync As New Object
        Public Shared CharactersSync As New Object
        ...
        Public Shared Sub OpenConnexion()
            ...
            Try
                ...
                ConnexionString = String.Concat("server=", Config.GetItem("SQL_IP"), ";" _
                       , "uid=", Config.GetItem("SQL_USER"), ";" _
                        , "pwd='", Config.GetItem("SQL_PASS"), "';" _
                        , "database=", Config.GetItem("SQL_CHARACTERS"), ";")

                Characters.ConnectionString = ConnexionString
                Characters.Open()
            ...
            Catch ex As MySqlException
                MyConsole.Err("Can't connect to MySQL server : " & vbCrLf & ex.ToString, True)
            End Try
